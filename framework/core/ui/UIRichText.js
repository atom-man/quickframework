...
exports.default = (() => {
    let _classDecorators = [ccclass, menu("Quick渲染组件/UIRichText")];
    ...
    var UIRichText = _classThis = class extends cc_1.RichText {
        constructor() {
            super(...arguments);
            /**@description 多谗言包 */
    ...
    __setFunctionName(_classThis, "UIRichText");
    (() => {
        ...
        UIRichText = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UIRichText = _classThis;
})();
