...
class CanvasHelper {
    ...
    saveFile(strData, type, fileName) {
    ...
    makeURL(strData, type) {
        return 'data:' + type + ';base64,' + strData;
    }
    genBitmapImage(oData) {
    ...
    savaAsImage(canvas, width, height, type = "png", fileName = "defaultpng") {
        /**
    ...
    convertToImage(canvas, width, height, type = "png") {
        ...
        if (this.support.canvas && this.support.dataURL) {
            ...
            if (/bmp/.test(type)) {
                ...
                var strData = this.getDataURL(_canvas, type, width, height);
                return this.genImage(strData);
            }
        }
    }
    fileDownload(downloadUrl, type, fileName) {
...
CanvasHelper.module = "【CanvasHelper】";
